...
def test_update_book_with_missing_records(client, two_saved_books):
    # Arrange
    test_data = {
        "title": "New Book",
        "description": "The Best!"
...
def test_update_book_with_invalid_id(client, two_saved_books):
    # Arrange
    test_data = {
        "title": "New Book",
        "description": "The Best!"
    ...
    # Act
    response = client.put("/books/two", json=test_data)
    response_body = response.get_json()

    # Assert
    assert response.status_code == 400
    assert response_body == {"message": "Book two invalid"}
...
def test_delete_book_with_invalid_id(client, two_saved_books):
    # Act
    response = client.delete("/books/two")
    response_body = response.get_json()
